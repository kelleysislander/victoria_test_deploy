class TrafficCameraSeed < ActiveRecord::Base
  
  # used in seeds.rb bercause it geocodes each record upon creation
  set_table_name  'traffic_cameras'
  ...
  # Conditionally reset coordinates and geocode, used in seeds.rb only to geocode the record
