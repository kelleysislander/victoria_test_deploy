/*
This selects either the historical or the actual traffic_conditions records based on left joining from tch to tc by 
traffic_camera_id and the time range as defined by 7:30 on either side of the tch.report_date (interval is 15:00 to be half each way)
